...
Original file is located at
    https://colab.research.google.com/drive/1yqHUQTtkjIiocgKejf1pW-WAp9EtIajE
"""
...
def resnet_v1(input_shape, depth, num_classes=118):
...
def resnet_v2(input_shape, depth, num_classes=118):
...
if not data_augmentation:
    ...
    model.fit(x_train, y_train,
              batch_size=batch_size,
              epochs=epochs,
              validation_data=(bw_X_train, bw_X_test),
              shuffle=True,
              callbacks=callbacks)