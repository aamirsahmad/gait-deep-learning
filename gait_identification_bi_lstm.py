...
lstm_model.add(Bidirectional(LSTM(128, return_sequences=True), input_shape=(n_steps, n_features)))
lstm_model.add(Bidirectional(LSTM(64, return_sequences=True), input_shape=(n_steps, n_features)))
